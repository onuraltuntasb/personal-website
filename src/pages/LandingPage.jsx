...
const LandingPage = () => {
    ...
    useEffect(() => {
        ...
        var i = 0;
        var txt = ' Hey!👋I’m Onur and I’m a Software Engineer for over 2.5 years. I’m currently working  as a freelancer in Turkey.';
        var speed = 50;
    ...
    const renderCarreerSteps = () => {
        return <>
            <div className="myjourney" >
                ...
                <p className="myjourney-header">It is important to make easy people's lives, discover new technologies but we should not forget power comes with responsibility so computer science not just programming it includes ethics</p>
            </div>
